...
userRouter.patch('/users/:userId', catchError(authMiddleware), updateAction('changeBoss'), catchError(userController.changeBoss));
userRouter.patch('/users/:userId', updateAction('changeToAdmin'), catchError(authMiddleware), catchError(userController.changeRoleToAdmin));
